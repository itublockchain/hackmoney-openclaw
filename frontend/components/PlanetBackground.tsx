...
export default function PlanetBackground({
  ...
  const topPlanetGradient =
    "radial-gradient(circle at 50% 30%, #f97316 10%, #e01b24 40%, #000000 90%)";

  // Black -> Red -> Orange (Bottom Planet)
  // Radial gradient centered at the bottom
  const bottomPlanetGradient =
    "radial-gradient(circle at 50% 70%, #f97316 10%, #e01b24 40%, #000000 90%)";
  ...
  return (
    <div className="relative w-full min-h-[calc(100vh-64px)] bg-black overflow-hidden flex items-start justify-center font-sans text-white">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 50% at 50% 50%, #ff8c00 0%, #e01b24 35%, #000000 70%)",
            filter: "blur(30px)",
          }}
        />
      ...
      {/* Content Layer */}
      <div className="relative z-30 w-full max-w-[1200px] mx-auto px-4 sm:px-6 py-16 sm:py-20 lg:py-24">
        {children}
      </div>
    </div>
  );
