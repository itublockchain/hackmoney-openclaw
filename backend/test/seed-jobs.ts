...
async function seedJobs() {
    ...
    try {
        ...
        // 2. Generate 100 jobs
        const statuses: JobStatus[] = ["open", "agreed", "submitted", "reviewing", "done"];
        ...
        for (let i = 0; i < 100; i++) {
            ...
            // Generate random budget between 0.0001 and 5.0 ETH
            const randomBudget = parseFloat((Math.random() * 5 + 0.0001).toFixed(6));
